        ...
        >
          ...
          <button
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 z-20 w-10 h-10 md:w-12 md:h-12 
                     ...
                     border border-gray-100 -ml-5 md:-ml-6"
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 z-20 w-10 h-10 md:w-12 md:h-12 
                     ...
                     text-slate-600 hover:text-orange-500
                     transition-all duration-300 hover:scale-110
                     border border-gray-100 -mr-5 md:-mr-6"
          ...
          <div className="overflow-hidden px-8 md:px-12">
            ...
            >
              {partners.map((partner, idx) => (
                <SwiperSlide key={idx}>
                  <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 hover:scale-105 p-6 h-28 flex items-center justify-center border border-gray-100">
                    <img 
