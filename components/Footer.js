    ...
    <footer className="bg-slate-900 text-slate-400 pt-16 pb-8">
      <div className="max-w-6xl mx-auto px-4">
          ...
          <motion.div className="lg:col-span-1" variants={fadeUp}>
            ...
            <div className="flex gap-3">
              ...
              <a
                ...
                className="w-9 h-9 bg-slate-800 rounded-lg flex items-center justify-center text-slate-400 hover:bg-red-500 hover:text-white transition-all duration-300"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                aria-label="WhatsApp"
                className="w-9 h-9 bg-slate-800 rounded-lg 
                flex items-center 
                justify-center 
                text-slate-400 hover:bg-red-500 
        ...
        >
          ...
          <p className="text-sm">Desenvolvido por <a href="#" className="hover:text-white transition-colors font-semibold">b2 marketing inustrial</a></p>
