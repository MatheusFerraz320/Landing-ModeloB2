...
export default function WhatsAppButton() {
  const phoneNumber = "5581992039379";
    ...
    <>
      ...
      >
        ...
        <div className="relative flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-full shadow-lg hover:shadow-xl hover:scale-110 active:scale-95 transition-all duration-300">
          ...
          <span className="absolute right-full mr-3 bg-white text-slate-700 text-sm font-medium px-3 py-1.5 rounded-lg shadow-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
