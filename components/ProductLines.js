/* ────────────────────────────────────────────────
   ProductLines — Seção de linha de produtos
   Personalize PRODUCTS_CONFIG abaixo.
──────────────────────────────────────────────── */

const PRODUCTS_CONFIG = {
  sectionTitle: "Linha de Produtos",
  sectionSubtitle:
...
export default function ProductLines({
  sectionTitle = PRODUCTS_CONFIG.sectionTitle,
  sectionSubtitle = PRODUCTS_CONFIG.sectionSubtitle,
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((product, idx) => (
            <div
              key={idx}
              className="group bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-xl hover:border-orange-100 transition-all duration-300"
            >
